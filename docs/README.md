...
6. [Day 1-4 Performance Calibration Review Addendum](reports/DAY_1_2_PERFORMANCE_CALIBRATION_REVIEW.md)
7. [Day 1 Operations & Performance Report](reports/DAY_1_OPERATIONS_AND_PERFORMANCE_REPORT.md)
8. [Day 2 Operations & Performance Report](reports/DAY_2_OPERATIONS_AND_PERFORMANCE_REPORT.md)
9. [Day 3 Operations & Performance Report](reports/DAY_3_OPERATIONS_AND_PERFORMANCE_REPORT.md)
10. [Day 4 Operations & Performance Report](reports/DAY_4_OPERATIONS_AND_PERFORMANCE_REPORT.md)
11. [Architecture](ARCHITECTURE.md)
12. [Data and API Contracts](DATA_API_CONTRACTS.md)
13. [Security](SECURITY.md)
14. [Implementation Plan](IMPLEMENTATION_PLAN.md)
...
- [Historical Backtest Simulation Report (v2)](backtest/BACKTEST_SIMULATION_REPORT_V2.md)
