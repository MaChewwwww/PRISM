...
Staging and production require distinct VPS paths, Compose project names, secrets, authentication values, Alpaca paper credentials when configured, and databases. Neither environment may enable live trading. Execution remains disabled unless separately reviewed and authorized.
