...
- **ShadowFund Counterfactual Simulator:** Continuously simulates alternative paths (Cash / No Action, Half Size, Contrarian / Inverse, Specialist Alternative) on the exact same price timeline.
