...
| :--- | :--- | :--- | :--- |
| [![01 News Agent](https://img.shields.io/badge/01-News_Agent-38BDF8?style=flat-square)](docs/AI_AGENTS.md) | *What occurred, when, and with what credibility?* | Ingests real-time Alpaca News (`/v2/news`), performs SHA-256 deduplication, and scores source credibility, sentiment, and confidence. | [![Research Only](https://img.shields.io/badge/Boundary-Research_Only-0284C7?style=flat-square)](docs/AI_AGENTS.md)<br/>Cannot propose orders |
| [![02 Quantitative Agent](https://img.shields.io/badge/02-Quantitative_Agent-00D084?style=flat-square)](docs/AI_AGENTS.md) | *What do price action, momentum, and volatility show?* | 100% deterministic technical calculations: RSI, MACD, Bollinger Bands, ATR, 20/50/200 SMAs, and annualized historical volatility. | [![Research Only](https://img.shields.io/badge/Boundary-Research_Only-0284C7?style=flat-square)](docs/AI_AGENTS.md)<br/>Decimal-safe inputs |
| [![03 Industry Agent](https://img.shields.io/badge/03-Industry_Agent-818CF8?style=flat-square)](docs/AI_AGENTS.md) | *How does this event affect sector peers and supply chains?* | Benchmarks sector dispersion, competitor sympathy moves, and industry-level catalysts. | [![Research Only](https://img.shields.io/badge/Boundary-Research_Only-0284C7?style=flat-square)](docs/AI_AGENTS.md)<br/>Cross-asset context |
| [![04 Fundamental Agent](https://img.shields.io/badge/04-Fundamental_Agent-6366F1?style=flat-square)](docs/AI_AGENTS.md) | *What are the balance sheet, cash flow, and margin implications?* | Evaluates live SEC EDGAR companyfacts taxonomy: debt-to-equity, free cash flow, operating margin, and earnings surprise. | [![Research Only](https://img.shields.io/badge/Boundary-Research_Only-0284C7?style=flat-square)](docs/AI_AGENTS.md)<br/>SEC filings taxonomy |
| [![05 Macroeconomic Agent](https://img.shields.io/badge/05-Macro_Agent-EC4899?style=flat-square)](docs/AI_AGENTS.md) | *How do interest rates, yields, and VIX influence systemic risk?* | Assesses macro climate, Treasury yield curves, Fed policy expectations, and cross-asset volatility. | [![Research Only](https://img.shields.io/badge/Boundary-Research_Only-0284C7?style=flat-square)](docs/AI_AGENTS.md)<br/>Systemic regime |
| [![06 Market Reaction Agent](https://img.shields.io/badge/06-Market_Reaction-F59E0B?style=flat-square)](docs/AI_AGENTS.md) | *Is the market reaction justified, overdone, or underdone?* | Quantifies catalyst decay, observed price displacement, and expected move to emit an **Opportunity Score** (0–100). | [![Opportunity Gate](https://img.shields.io/badge/Boundary-Opportunity_Gate-F59E0B?style=flat-square)](docs/AI_AGENTS.md)<br/>May emit `NO_CLEAR_EDGE` |
| [![07 Trading Decision Agent](https://img.shields.io/badge/07-Trading_Decision-10B981?style=flat-square)](docs/AI_AGENTS.md) | *Is there a viable options trade with positive net EV?* | Synthesizes all perspectives to construct a structured `TradeProposal` (structure, strikes, DTE, limit debits) or emits `NO_TRADE`. | [![Proposal Only](https://img.shields.io/badge/Boundary-Proposal_Only-10B981?style=flat-square)](docs/AI_AGENTS.md)<br/>Zero execution power |

### Downstream Governance & Autonomous Execution

- [![Adversarial Risk](https://img.shields.io/badge/Adversarial_Risk-F59E0B?style=flat-square)](docs/AI_AGENTS.md) **Agent:** Scrutinizes proposal viability against current market volatility, correlated positions, and contradictory evidence.
- [![Rules Engine](https://img.shields.io/badge/Deterministic_Rules-547D83?style=flat-square)](docs/BUSINESS_RULES.md) **(P0–P5):** Evaluates mathematical constraints (`PASS`, `MODIFY`, `FAIL`) and returns aggregate `APPROVE`, `REJECT`, or `MODIFIED_PENDING_ACCEPTANCE`.
- [![Alpaca Gate](https://img.shields.io/badge/Alpaca-Paper_Gate-0F172A?style=flat-square)](docs/SECURITY.md) **Execution Gate:** Re-validates paper mode, kill switch, fresh quotes (<= 30s), and payload digests before dispatching orders via the Alpaca API & CLI.
- [![ShadowFund](https://img.shields.io/badge/ShadowFund-Counterfactuals-818CF8?style=flat-square)](docs/SHADOWFUND.md) **Simulator:** Continuously simulates alternative paths including cash preservation, half sizing, contrarian positions, and specialist variants on the exact same price timeline.
- [![Post-Analysis](https://img.shields.io/badge/Post--Analysis-Weekly_Learning-10B981?style=flat-square)](docs/AI_PROFILES.md) **Engine:** Evaluates closed trades and ShadowFund outcomes post-close to recommend strictly bounded AI Profile adjustments (`target_position_size_pct`, `opportunity_score_threshold`).
