...
const SEEDED_EMAIL = "operator@prism.local";
const SEEDED_PASSWORD = "prism-staging-2026!";
            ...
            <div className="rounded border border-[var(--border)] bg-[var(--surface-raised)]/60 p-3 text-xs backdrop-blur-sm">
              <div className="flex items-center justify-between">
                <div className="flex items-center gap-2 font-medium text-[var(--foreground)]">
                  ...
                  <span>Seeded Hackathon Account</span>
                </div>
                <button
                  type="button"
              ...
              <p className="mt-1 font-mono text-[0.7rem] text-[var(--muted-foreground)]">
                operator@prism.local · prism-staging-2026!
              </p>
            </div>
